...
class GFAlertVC: UIViewController {
    ...
    func configureTitleLabel() {
        ...
        titleLabel.text = alertTitle ?? "something went wrong"          // double ?? (nil Coalescing unwrap option, use alert title, else NIL
        
        //padding is 20, declared earlier as value 20
        NSLayoutConstraint.activate([
